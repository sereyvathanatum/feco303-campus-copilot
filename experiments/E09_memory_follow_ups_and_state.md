...
## Steps
1. Run `python -m campus_copilot.cli eval --subset follow_up` with the baseline (`laya_gated`), `e09_condense_off`, and `e09_condense_always`.
...
## Questions
1. What does `always` cost that `laya_gated` saves?
